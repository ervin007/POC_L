...
if __name__ == '__main__':
    ...
    ### We would fir the finetuned folder contents here
    model = BertForMaskedLM.from_pretrained(LOCAL_MLM_DIR, num_labels=5,  force_download=True)
    ...
    ### We would feed the BTF folder contents here
    ...
    ### We would feed our train and validation data folders here alongside the dataset_dict json file
